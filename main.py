...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    print('error_mod3=',test_error_mod3)
    return test_error
...
print('softmax test_error_pca=', test_error)
...
model.fit(train_pca10,train_y)

predict_y_svm = model.predict(test_pca10)

error_svm_pc10 = compute_test_error_svm(test_y,predict_y_svm)

print('error on SVM_pc10=', error_svm_pc10)

model_2 = SVC(random_state = 0, kernel = 'rbf')
model_2.fit(train_pca10,train_y)

predict_y_svm = model_2.predict(test_pca10)

error_svm_pc10_rbf = compute_test_error_svm(test_y,predict_y_svm)

print('error on SVM_pc10_rbf=', error_svm_pc10_rbf)
